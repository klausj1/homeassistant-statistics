...
- Export with \t does not work - TypeError: "delimiter" must be a 1-character string
- Export of mixed data does not work - sum is not included; maybe beause I imported sum only?
- state only cannot be imported
- empty delimiter?
- Default timezone: a la import, Europe/Vienna